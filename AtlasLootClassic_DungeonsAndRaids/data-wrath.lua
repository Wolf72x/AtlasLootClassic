...
data["TheCullingOfStratholme"] = {
    name = AL["The Culling Of Stratholme"],
	...
	items = {
        ...
        { -- OcuEregos / 64
            ...
            [HEROIC_DIFF] = {
                ...
                { 16, 43102 }, -- Frozen Orb
                { 18, 52676},
                { 20, 41798 }, -- Design: Bracing Earthsiege Diamond
                { 22, "ac1868" },
                { 23, "ac1871" },
                { 24, "ac2046" },
                { 25, "ac2045" },
	...
	items = {
        { -- Malygos / 180
            ...
            [RAID25_DIFF] = {
                ...
                { 23, 44577 }, -- Heroic Key to the Focusing Iris
                { 24, 44651 }, -- Heart of Magic
                { 26, "ac623" },
				{ 27, "ac1658" },
				{ 28, "ac1870" },
				{ 29, "ac2149" },
	...
	items = {
        ...
        { -- UlduarXT-002 Deconstructor
            ...
            [RAID10_DIFF] = {
				...
				{ 11, 45685 },	-- Plasma Foil
				{ 12, 45682 },	-- Pulsing Spellshield
        ...
        { -- UlduarIronCouncil
            ...
            [RAID10_DIFF] = {
                ...
                { 11, 45332 },	-- Stormtip
				{ 12, 45331 },	-- Rune-Etched Nightblade
        ...
        { -- UlduarKologarn
            ...
            [RAID10_DIFF] = {
              { 1, 45704 },	-- Shawl of the Shattered Giant
				...
				{ 11, 45700 },	-- Stoneguard
				{ 12, 45695 },	-- Spire of Withering Dreams
                { 16, "ac2953" },
				{ 17, "ac2955" },
				{ 18, "ac2959" },
				{ 19, "ac2951" },
        ...
        { -- UlduarAuriaya
            ...
            [RAID10_DIFF] = {
				...
				{ 11, 45707 },	-- Shieldwall of the Breaker
				{ 12, 45713 },	-- Nurturing Touch
                { 16, "ac3006" },
                { 17, "ac3076" },
            },
            [RAID25_DIFF] = {
        ...
        { -- UlduarHodir
            ...
            [RAID10_DIFF] = {
                ...
                { 16, "ac3182", nil, nil, AL["Hard Mode"] },
                ...
                { 25, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil, "AC_UlduarHodir10" },
            },
            [RAID25_DIFF] = {
                ...
                { 16, 45038 }, -- Fragment of Val'anyr
                { 18, "ac3184", nil, nil, AL["Hard Mode"] },
                { 19, 45461 }, -- Drape of Icy Intent
                { 20, 45462 }, -- Gloves of the Frozen Glade
                { 21, 45460 }, -- Bindings of Winter Gale
                { 22, 45459 }, -- Frigid Strength of Hodir
                { 23, 45612 }, -- Constellus
                { 24, 45457 }, -- Staff of Endless Winter
                { 27, 45815 }, -- Hodir's Sigil
                
              
                { 29, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil, "AC_UlduarHodir25" },
            }
        },
        { -- UlduarThorim
            name = AL["Thorim"],
            ...
            [RAID10_DIFF] = {
                ...
                { 16, "ac3176", nil, nil, AL["Hard Mode"] },
                ...
                { 25, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil, "AC_UlduarThorim10" },
            ...
            [RAID25_DIFF] = {
                ...
                { 7, 45638 }, -- Crown of the Wayward Conqueror
                { 8, 45639 }, -- Crown of the Wayward Protector
                { 9, 45640 }, -- Crown of the Wayward Vanquisher   
                { 16, 45038 }, -- Fragment of Val'anyr
                { 18, "ac3183", nil, nil, AL["Hard Mode"] },
                { 19, 45473 }, -- Embrace of the Gladiator
                { 20, 45474 }, -- Pauldrons of the Combatant
                { 21, 45472 }, -- Warhelm of the Champion
                { 22, 45471 }, -- Fate's Clutch
                { 23, 45570 }, -- Skyforge Crossbow
                { 24, 45470 }, -- Wisdom's Hold
                { 26, 45817 }, -- Thorim's Sigil
                { 28, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil, "AC_UlduarThorim25" },
            }
        },
        { -- UlduarFreya
            name = AL["Freya"],
            ...
            [RAID10_DIFF] = {
                ...
                { 16, "ac3179", nil, nil, AL["Hard Mode"] },
                ...
                { 25, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil, "AC_UlduarFreya10" },
            },
            [RAID25_DIFF] = {
                ...
                { 7, 45653 }, -- Legplates of the Wayward Conqueror
                { 8, 45654 }, -- Legplates of the Wayward Protector
                { 9, 45655 }, -- Legplates of the Wayward Vanquisher
                { 11, 46110 }, -- Alchemist's Cache
                { 16, 45038 }, -- Fragment of Val'anyr
                { 18, "ac3187", nil, nil, AL["Hard Mode"] },
                { 19, 45486 }, -- Drape of the Sullen Goddess
                { 20, 45488 }, -- Leggings of the Enslaved Idol
                { 21, 45487 }, -- Handguards of Revitalization
                { 22, 45485 }, -- Bronze Pendant of the Vanir
                { 23, 45484 }, -- Bladetwister
                { 24, 45613 }, -- Dreambinder
                { 26, 45814 }, -- Freya's Sigil
                { 28, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil, "AC_UlduarFreya25" },
            }
        },
        { -- UlduarMimiron
            name = AL["Mimiron"],
            ...
            [RAID10_DIFF] = {
                ...
                { 16, "ac3180", nil, nil, AL["Hard Mode"] },
            ...
            [RAID25_DIFF] = {
                ...
                { 7, 45641 }, -- Gauntlets of the Wayward Conqueror
                { 8, 45642 }, -- Gauntlets of the Wayward Protector
                { 9, 45643 }, -- Gauntlets of the Wayward Vanquisher
                { 16, 45038 }, -- Fragment of Val'anyr
                { 18, "ac3189", nil, nil, AL["Hard Mode"] },
                { 19, 45496 }, -- Titanskin Cloak
                { 20, 45497 }, -- Crown of Luminescence
                { 21, 45663 }, -- Armbands of Bedlam
                { 22, 45495 }, -- Conductive Seal
                { 23, 45494 }, -- Delirium's Touch
                { 24, 45620 }, -- Starshard Edge
                { 25, 45816 }, -- Mimiron's Sigil
        ...
        { -- Trash
            ...
            [RAID25_DIFF] = {
				...
				{ 16, 45540 },	-- Bladebearer's Signet
				{ 17, 45539 },	-- Pendant of Focused Energies
				{ 18, 45538 },	-- Titanstone Pendant
				{ 20, 45605 },	-- Daschal's Bite
            },
        },
        { -- Patterns
            name = AL["Patterns"],
...
data["TrialoftheCrusader"] = {
	...
	items = {
        ...
        {	-- Argent Crusade Tribute Chest
            ...
            [RAID10H_DIFF] = AtlasLoot:GetRetByFaction(
                { -- horde
                    { 1, "ac3812",nil,nil, AL["Bonus Loot "]},
                    { 2, 47242, [ATLASLOOT_IT_AMOUNT1] = 2 },	-- Trophy of the Crusade

                    { 4, "ac3817",nil,nil, AL["Bonus Loot "].."(25)"},
                    { 5, 48703 }, --  The Facebreaker
                    { 6, 48699 }, --  Blood and Glory
                    { 7, 48693 }, --  Heartsmasher
                    { 8, 48701 }, --  Spellharvest
                    { 9, 48697 }, -- Frenzystrike Longbow
                    { 10, 48705 }, -- Attrition
                    { 11, 48695 }, -- Mor'kosh

                    { 16, "ac3818",nil,nil, AL["Bonus Loot "].."(45)"},
                    { 17, 47242, [ATLASLOOT_IT_AMOUNT1] = 2 },	-- Trophy of the Crusade

                    { 19, "ac3819",nil,nil, AL["Bonus Loot "].."(50)"},
                    { 20, 48669 }, -- Cloak of the Triumphant Combatant
                    { 21, 48668 }, -- Cloak of Serrated Blades
                    { 22, 48670 }, -- Cloak of the Unflinching Guardian
                    { 23, 48666 }, -- Drape of the Sunreavers
                    { 24, 48667 }, -- Shawl of the Devout Crusader
                    { 26, 49046 }, -- Swift Horde Wolf
                },
                { -- alli                  
                    { 1, "ac3812",nil,nil, AL["Bonus Loot "]},
                    { 2, 47242, [ATLASLOOT_IT_AMOUNT1] = 2 },	-- Trophy of the Crusade
                    ...
                    { 4, "ac3817",nil,nil, AL["Bonus Loot "].."(25)"},
                    { 5, 48712 }, --  The Spinebreaker
                    { 6, 48714 }, --  Honor of the Fallen
                    { 7, 48709 }, --  Heartcrusher
                    { 8, 48708 }, --  Spellstorm Blade
                    { 9, 48711 }, -- Rhok'shalla the Shadow's Bane
                    { 10, 48710 }, --  Paragon's Breadth
                    { 11, 48713 }, --  Lothar's Edge

                    { 16, "ac3818",nil,nil, AL["Bonus Loot "].."(45)"},
                    { 17, 47242, [ATLASLOOT_IT_AMOUNT1] = 2 },	-- Trophy of the Crusade

                    { 19, "ac3819",nil,nil, AL["Bonus Loot "].."(50)"},
                    { 20, 48674 }, -- Cloak of the Victorious Combatant
                    { 21, 48673 }, -- Cloak of the Silver Covenant
                    { 22, 48675 }, -- Cloak of the Unmoving Guardian
                    { 23, 48671 }, -- Drape of Bitter Incantation
                    { 24, 48672 }, -- Shawl of Fervent Crusader
                    { 26, 49044 }, -- Swift Alliance Steed
                }
            ),
            [RAID25H_DIFF] = AtlasLoot:GetRetByFaction(
                { -- horde
                    ...
                    { 4, 47559 }, -- Regalia of the Grand Vanquisher

                    { 6, "ac3817",nil,nil, AL["Bonus Loot "].."(25)"},
                    { 7, 47513 }, -- Orgrim's Deflector
                    { 8, 47528 }, -- Cudgel of the Damned
                    { 9, 47518 }, -- Mortalis
                    { 10, 47520 }, -- Grievance
                    { 11, 47523 }, -- Fezzik's Autocannon
                    { 12, 47525 }, -- Sufferance
                    { 13, 47516 }, -- Fleshrender

                    { 16, "ac3818",nil,nil, AL["Bonus Loot "].."(45)"},
                    { 18, 47557 }, -- Regalia of the Grand Conqueror
                    { 19, 47558 }, -- Regalia of the Grand Protector
                    { 20, 47559 }, -- Regalia of the Grand Vanquisher

                    { 21, "ac3819",nil,nil, AL["Bonus Loot "].."(50)"},
                    { 22, 47548 }, -- Garrosh's Rage
                    { 23, 47546 }, -- Sylvanas' Cunning
                    { 24, 47550 }, -- Cairne's Endurance
                    { 25, 47551 }, -- Aethas' Intensity
                    { 26, 47554 }, -- Lady Liadrin's Conviction
                ...
                { -- alli
                    ...
                    { 2, 47557 }, -- Regalia of the Grand Conqueror
                    { 3, 47558 }, -- Regalia of the Grand Protector
                    { 4, 47559 }, -- RRegalia of the Grand Vanquisher
                    
                    { 6, "ac3817",nil,nil, AL["Bonus Loot "].."(25)"},
                    { 7, 47506 }, -- Silverwing Defender
                    { 8, 47526 }, -- Remorseless
                    { 9, 47517 }, -- Blade of the Unbroken Covenant
                    { 10, 47519 }, -- Catastrophe
                    { 11, 47521 }, -- BRK-1000
                    { 12, 47524 }, -- Clemency
                    { 13, 47515 }, -- Decimation

                    { 16, "ac3818",nil,nil, AL["Bonus Loot "].."(45)"},
                    { 17, 47557 }, -- Regalia of the Grand Conqueror
                    { 18, 47558 }, -- Regalia of the Grand Protector
                    { 19, 47559 }, -- Regalia of the Grand Vanquisher

                    { 21, "ac3819",nil,nil, AL["Bonus Loot "].."(50)"},
                    { 22, 47547 }, -- Varian's Furor
                    { 23, 47545 }, -- Vereesa's Dexterity
                    { 24, 47549 }, -- Magni's Resolution
                    { 25, 47552 }, -- Jaina's Radiance
                    { 26, 47553 }, -- Bolvar's Devotion
