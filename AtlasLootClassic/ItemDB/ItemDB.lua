...
local SpecialMobList = {
	rare = format(PATH_TEXTURE, "Interface\\AddOns\\AtlasLootClassic\\Images\\Icons\\nameplates-icon-elite-silver"),
	elite = format(PATH_TEXTURE, "Interface\\AddOns\\AtlasLootClassic\\Images\\Icons\\nameplates-icon-elite-gold"),
	quest = format(PATH_TEXTURE, "Interface\\GossipFrame\\ActiveQuestIcon"),
	questTurnIn = format(PATH_TEXTURE, "Interface\\GossipFrame\\AvailableQuestIcon"),
	boss = format(PATH_TEXTURE, "Interface\\TargetingFrame\\UI-TargetingFrame-Skull"),
	vendor = format(PATH_TEXTURE, "Interface\\MINIMAP\\TRACKING\\Auctioneer"),
	summon = format(PATH_TEXTURE, "Interface\\MINIMAP\\TRACKING\\Innkeeper"),
}
