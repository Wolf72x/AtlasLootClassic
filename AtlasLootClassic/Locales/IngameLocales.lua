...
local IngameLocales = {
	...
	["Jewelcrafting"] = GetSpellInfo(25229) or UNKNOWN,
	...
	["Bucklers"]  = ITEM_SUBCLASS_ARMOR_BUCKLER,
	["Shields"]   = ITEM_SUBCLASS_ARMOR_SHIELD,
	["Librams"]   = ITEM_SUBCLASS_ARMOR_LIBRAM,
	["Idols"]     = ITEM_SUBCLASS_ARMOR_IDOL,
	["Totems"]    = ITEM_SUBCLASS_ARMOR_TOTEM,
	...
	["One-Handed Axes"]   = ITEM_SUBCLASS_WEAPON_AXE,
	["Two-Handed Axes"]   = ITEM_SUBCLASS_WEAPON_AXE2,
	["Bows"]              = ITEM_SUBCLASS_WEAPON_BOW,
	["Guns"]              = ITEM_SUBCLASS_WEAPON_GUN,
	["One-Handed Maces"]  = ITEM_SUBCLASS_WEAPON_MACE,
	["Two-Handed Maces"]  = ITEM_SUBCLASS_WEAPON_MACE2,
	["Polearms"]          = ITEM_SUBCLASS_WEAPON_POLEARM,
	["One-Handed Swords"] = ITEM_SUBCLASS_WEAPON_SWORD,
	["Two-Handed Swords"] = ITEM_SUBCLASS_WEAPON_SWORD2,
	["Staves"]            = ITEM_SUBCLASS_WEAPON_STAFF,
	["Fist Weapons"]      = ITEM_SUBCLASS_WEAPON_FIST,
	["Daggers"]           = ITEM_SUBCLASS_WEAPON_DAGGER,
	["Crossbows"]         = ITEM_SUBCLASS_WEAPON_CROSSBOW,
	["Wands"]             = ITEM_SUBCLASS_WEAPON_WAND,
	["Fishing Pole"]      = ITEM_SUBCLASS_WEAPON_FISHINGPOLE,
	["Projectile"]  = ITEM_CLASS_PROJECTILE,
	["Bullet"]      = ITEM_SUBCLASS_PROJECTILE_BULLET,
	["Parts"]       = ITEM_SUBCLASS_TRADE_GOODS_PARTS,
	["Explosives"]  = ITEM_SUBCLASS_TRADE_GOODS_EXPLOSIVES,
	-- ######################################################################
	-- Gems
	-- ######################################################################
