...
function GUI:Create()
	...
	-- Center
	-- #####
	frame.contentFrame.searchBox = CreateFrame("EditBox", frameName.."-SearchBox", frame.contentFrame)
	...
	frame.contentFrame.searchBox:SetBackdrop(ALPrivate.BOX_BORDER_BACKDROP)
	frame.contentFrame.searchBox:SetFontObject(GameFontHighlightSmall)
	frame.contentFrame.searchBox:SetTextInsets(5, 5, 5, 5)
	frame.contentFrame.searchBox:SetBackdropColor(0,0,0,1)
	local icon = frame.contentFrame:CreateTexture(nil, "ARTWORK")
	icon:SetSize(14, 14)
	icon:SetPoint("LEFT", 6, 0)
	icon:SetTexture("Interface\\Icons\\INV_Misc_Spyglass_03")
	frame.contentFrame.searchIcon = icon
	--]]

	GUI.CreateSearch(frame.contentFrame.searchBox)
...
function GUI.RefreshContentBackGround()
	...
	if db.contentTopBar.useContentColor and ( frame.topBG.curAlpha ~= db.contentTopBar.bgColor.a or frame.topBG.curColor ~= GUI.curBgInfo[1]) then
		frame.topBG:SetTexture(GUI.curBgInfo[1][1], GUI.curBgInfo[1][2], GUI.curBgInfo[1][3], db.contentTopBar.bgColor.a)
	...
	elseif not db.contentTopBar.useContentColor and frame.topBG.curColor ~= db.contentTopBar.bgColor then
		frame.topBG:SetTexture(db.contentTopBar.bgColor.r, db.contentTopBar.bgColor.g, db.contentTopBar.bgColor.b, db.contentTopBar.bgColor.a)
	...
	elseif not db.content.showBgImage or not GUI.curBgInfo[2] then
		...
		GUI.frame.contentFrame.itemBG:SetTexture(db.content.bgColor.r, db.content.bgColor.g, db.content.bgColor.b, db.content.bgColor.a)
	end
	...
	if db.contentBottomBar.useContentColor and ( frame.downBG.curAlpha ~= db.contentBottomBar.bgColor.a or frame.downBG.curColor ~= GUI.curBgInfo[1]) then
		frame.downBG:SetTexture(GUI.curBgInfo[1][1], GUI.curBgInfo[1][2], GUI.curBgInfo[1][3], db.contentTopBar.bgColor.a)
	...
	elseif not db.contentBottomBar.useContentColor and frame.downBG.curColor ~= db.contentBottomBar.bgColor then
		frame.downBG:SetTexture(db.contentBottomBar.bgColor.r, db.contentBottomBar.bgColor.g, db.contentBottomBar.bgColor.b, db.contentBottomBar.bgColor.a)
