...
local FACTION_IMAGES = {
	...
	-- Wrath
	[1037] = "interface\\icons\\inv_shield_36", -- Alliance Vanguard
	[1106] = "interface\\icons\\ability_warrior_swordandboard", -- Argent Crusade
}
...
function Faction.ShowToolTipFrame(button)
	...
	local newWidth = 30 + frame.name:GetStringWidth()
