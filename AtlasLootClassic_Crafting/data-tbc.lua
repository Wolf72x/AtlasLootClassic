...
data["RoguePoisonsBC"] = {
	name = format("|cff%02x%02x%02x%s|r", math.floor(RAID_CLASS_COLORS.ROGUE.r*255), math.floor(RAID_CLASS_COLORS.ROGUE.g*255), math.floor(RAID_CLASS_COLORS.ROGUE.b*255), ALIL["ROGUE"]),
