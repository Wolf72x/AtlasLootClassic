...
local MAJOR_GLYPHS_DIFF = data:AddDifficulty(AL["Major Glyphs"], "majorglyphs", 0)
local MINOR_GLYPHS_DIFF = data:AddDifficulty(AL["Minor Glyphs"], "minorglyphs", 0)
...
local GEM_FORMAT1 = AL["Auction Gems"].." - %s"
local GEM_FORMAT2 = AL["Auction Gems"].." - %s & %s"
...
data["JewelcraftingWrath"] = {
	...
	items = {
		{
			name = ALIL["Jewelcrafting"].." - "..AL["Auction Gems"],
			[NORMAL_DIFF] = {
				-- red
