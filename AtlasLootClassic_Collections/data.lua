...
data["ZGSets"] = {
	name = format(AL["%s Sets"], AL["Zul'Gurub"]),
	ContentType = SET_CONTENT,
...
data["AQSets"] = {
	name = format(AL["%s Sets"], AL["Ahn'Qiraj"]),
	ContentType = SET_CONTENT,
	LoadDifficulty = LOAD_DIFF,
	TableType = SET_ITTYPE,
	gameVersion = AtlasLoot.CLASSIC_VERSION_NUM,
	items = {
		{ -- AQ20
			name = format(AL["%s Sets"], AL["Ahn'Qiraj"].." 20"),
			[ALLIANCE_DIFF] = {
				{ 1,  500 }, -- Warlock
				{ 3,  508 }, -- Priest
				{ 16, 504 }, -- Mage
		...
		{ -- AQ40
			name = format(AL["%s Sets"], AL["Ahn'Qiraj"].." 40"),
			[ALLIANCE_DIFF] = {
				{ 1,  499 }, -- Warlock
				{ 3,  507 }, -- Priest
				{ 16, 503 }, -- Mage
...
data["Mounts"] = {
	...
	items = {
		...
		{ -- AQ40
			name = ALIL["The Temple of Ahn'Qiraj"],
			MapID = 3428,
			[NORMAL_DIFF] = {
