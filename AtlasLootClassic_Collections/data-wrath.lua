...
data["DalaranVendor"] = {
	name = format(AL["%s Vendor"], AL["Dalaran"]),
...
data["ValentinedayWrath"] = {
	...
	items = {
		...
		{ -- SFKApothecaryH
			name = AL["Shadowfang Keep"].." - "..AL["Apothecary Hummel"],
			[NORMAL_DIFF] = {
...
data["MidsummerFestivalWrath"] = {
	...
	items = {
		...
		{ -- CFRSlaveAhune
			name = AL["The Slave Pens"].." - "..AL["Ahune"],
			[NORMAL_DIFF] = {
...
data["BrewfestWrath"] = {
	...
	items = {
		...
		{
			name = AL["Blackrock Depths"].." - "..AL["Coren Direbrew"],
			[NORMAL_DIFF] = {
...
data["HalloweenWrath"] = {
	...
	items = {
		...
		{ -- SMHeadlessHorseman
			name = AL["Scarlet Monastery"].." - "..AL["Headless Horseman"],
			[NORMAL_DIFF] = {
...
data["ScourgeInvasionWrath"] = {
	...
	items = {
		...
		{
			name = AL["Karazhan"].." - "..AL["Prince Tenris Mirkblood"],
			[NORMAL_DIFF] = {
